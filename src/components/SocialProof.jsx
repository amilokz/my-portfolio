    ...
    <section id="socialproof" className="py-5 text-white" style={{ background: "transparent" }}>
      <div className="container">
        ...
        <div className="d-flex justify-content-center gap-4 flex-wrap">
          <motion.div className="social-proof-card p-3 rounded-4 text-center" style={{ background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.06)" }}>
            <FaGithub className="gh-icon" size={30} color="#ffffff" />
          ...
          <motion.div className="social-proof-card p-3 rounded-4 text-center" style={{ background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.06)" }}>
            <FaLinkedin className="li-icon" size={30} />
          ...
          <motion.a href="https://wa.me/923238559822" className="social-proof-card p-3 rounded-4 text-center" style={{ background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.06)" }}>
            <FaWhatsapp className="wa-icon" size={30} />
